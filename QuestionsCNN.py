...
embeddingSize = 100
# load the vocabulary
vocab_filename = 'questionsVocab.txt'
...
[all_docs, labels] = load_docs('Questions.csv', vocab, map)
...
callback = callbacks.EarlyStopping(monitor='val_acc',
                              ...
                              patience=0,
                              verbose=0, mode='auto')
history = nn.fit(Xtrain, yTrain_c, epochs=10, validation_split=0.10,callbacks=[callback])
